...
react_data_table_component_1.createTheme('solarized', {
    text: {
        primary: '#268bd2',
        secondary: '#2aa198'
    },
...
var TransactionCard = function (_a) {
    var tokenName = _a.tokenName, contract = _a.contract;
    var _b = react_1["default"].useState(false), hideDirector = _b[0], setHideDirector = _b[1];
    ...
    return (react_1["default"].createElement(uikit_1.Card, null,
        react_1["default"].createElement(react_data_table_component_1["default"], { columns: columns, data: data, fixedHeader: fixedHeader, fixedHeaderScrollHeight: "350px" })));
};
